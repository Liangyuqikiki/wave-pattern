function [F,c_v,c_v2,BIC1,BIC2] = granger_cause(x,y,alpha,max_lag)
...
[dummy,x_lag] = min(BIC1);

%First find the proper model specification using the Bayesian Information
%Criterion for the number of lags of y

BIC2 = zeros(max_lag,1);
...
c_v2 = 1-fcdf(F,y_lag,(T-(x_lag+y_lag+1)));
